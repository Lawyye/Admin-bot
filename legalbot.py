import asyncio import logging import sqlite3 import threading from datetime import datetime import os import json
...
bot = Bot(token=API_TOKEN) dp = Dispatcher(storage=MemoryStorage())
